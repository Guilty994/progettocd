function [regen_matrices] = encode_decode_AV1_libaom(matrix, height, width, hologram_name, hologram_path)
...
% ~ = ingnored value
[Y_Hol3D_decoded,~,~] = yuv_import(strcat(hologram_path, 'yuv/output_libaom_av1_reconstructed.yuv'),[width height],1);
